...
public class ElasticsearchCrossCaseTypeSearchSecurityTest extends ElasticsearchBaseTest {
    ...
    class CaseTypeSecurity {
        ...
        @Test
        @DisplayName("should return cases only for case types user has access to - the user role can read case type and has same security classification as "
                         + "case type")
    ...
    private ValidatableResponse searchCaseWithSourceFilter(Supplier<RequestSpecification> asUser, String field, Object value, String... sourceFilters) {
        ...
        return searchCase(asUser, jsonSearchRequest, AATCaseType.AAT_PRIVATE_CASE_TYPE, AATCaseType.AAT_PRIVATE2_CASE_TYPE);
    }
